...
def main() ->int:
    ...
    tk.Radiobutton(window, text="Real and imagine opening and closing left fist or right fist", font=("Arial", 12), variable=expVar, value=3).pack(anchor="w")
    tk.Radiobutton(window, text="Real and imagine opening and closing both fists or feet", font=("Arial", 12), variable=expVar, value=3).pack(anchor="w")
    ...
    print(f"{colors.Magenta} Bye see you soon{colors.Reset}")
    return 0
