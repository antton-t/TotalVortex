...
def main() ->int:
    ...
    tk.Radiobutton(window, text="Real and imagine opening and closing left fist or right fist", font=("Arial", 12), variable=expVar, value=4).pack(anchor="w")
    tk.Radiobutton(window, text="Real and imagine opening and closing both fists or feet", font=("Arial", 12), variable=expVar, value=5).pack(anchor="w")
